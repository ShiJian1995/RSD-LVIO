...
int opencv_buildOpticalFlowPyramid(cv::InputArray img, cv::OutputArrayOfArrays pyramid,
...
void calculate_LK_optical_flow(const cv::Range &range, const cv::Mat *_prevImg, const cv::Mat *_prevDeriv, const cv::Mat *_nextImg,
